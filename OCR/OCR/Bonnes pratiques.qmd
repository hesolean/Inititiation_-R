...
**Conseil n° 2** pour éviter les erreurs : Maintenir les packages, R et Rstudio à jour. Les packages peuvent être mis à jour dans l’onglet Packages puis en cliquant sur Update ou dans le menu Tools \> Check for Package Update . À faire au moins une fois par mois.
